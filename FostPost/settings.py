"""
Django settings for FostPost project.
...
WSGI_APPLICATION = 'FostPost.wsgi.application'
...
MEDIA_URL = '/media/'
STATIC_ROOT = '/home/ec2-user/FostPost_OpenStack/FostPost/static/'
